...
public class PositiveInfTest {
    ...
    public void testJoin() {
        assertTrue(p3.join(top).equals(top));
        assertTrue(p3.join(bot).equals(p3));
    ...
    public void testWiden() {
        assertTrue(p3.widen(top).equals(top));
        assertTrue(p3.widen(bot).equals(p3));
    ...
    public void testDiv() {
        ...
        assertTrue(p1.div(n1).equals(n3));
        assertTrue(p1.div(n2).equals(top));
        assertTrue(p1.div(n3).equals(top));
        assertTrue(p1.div(new NegativeInf(5)).equals(top));
        assertTrue(p1.div(new NegativeInf(-5)).equals(n2));

        assertTrue(p2.div(n1).equals(n2));
        assertTrue(p2.div(n2).equals(top));
        assertTrue(p2.div(n3).equals(top));
        assertTrue(p2.div(new NegativeInf(5)).equals(top));
        assertTrue(p2.div(new NegativeInf(-5)).equals(n2));

        assertTrue(p3.div(n1).equals(n2));
        assertTrue(p3.div(n2).equals(top));
        assertTrue(p3.div(n3).equals(top));
        assertTrue(p3.div(new NegativeInf(5)).equals(top));
        assertTrue(p3.div(new NegativeInf(-5)).equals(n2));
        
        assertTrue(p5.div(n1).equals(n2));
        assertTrue(p5.div(n2).equals(top));
        assertTrue(p5.div(n3).equals(top));
        assertTrue(p5.div(new NegativeInf(5)).equals(top));
        assertTrue(p5.div(new NegativeInf(-5)).equals(n2));
        
        assertTrue(pm5.div(n1).equals(new NegativeInf(5)));
        assertTrue(pm5.div(n2).equals(top));
        assertTrue(pm5.div(n3).equals(top));
        assertTrue(pm5.div(new NegativeInf(5)).equals(top));
