...
public class IfStmtCommand extends StmtCommand {
    ...
    public void execute() {
        ...
        switch (condition.getClass().getName()) {
            ...
            case "soot.jimple.internal.JNeExpr":
                logicalOp = new NeqOp();
                break;
            case "soot.jimple.internal.JGeExpr":
                logicalOp = new GeOp();
                break;
            case "soot.jimple.internal.JLeExpr":
                logicalOp = new LeOp();
                break;
            case "soot.jimple.internal.JLtExpr":
                logicalOp = new LtOp();
                break;
            case "soot.jimple.internal.JGtExpr":
                logicalOp = new GtOp();
                break;
            case "soot.jimple.internal.JEqExpr":
                logicalOp = new EqOp();
                break;
        }
