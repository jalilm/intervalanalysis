...
public class TestLogicalOps {
	...
	public void testEq() throws Exception {
		// [-1,1]==[5,5] = bottom
		assertEquals(bottomState, eq.op(twoVariablesState, a, IntConstant.v(5)));
		assertEquals(bottomState, eq.op(threeVariablesState, a, c));
	...
	public void testGt() throws Exception {
		// [-1,1]>[5,5] = bottom
		assertEquals(bottomState, gt.op(twoVariablesState, a, IntConstant.v(5)));
		assertEquals(bottomState, gt.op(twoVariablesState, IntConstant.v(-5),a));
		assertEquals(bottomState, gt.op(twoVariablesState, IntConstant.v(3),IntConstant.v(5)));
		assertEquals(bottomState, gt.op(twoVariablesState, a, a));
	...
	public void testNeq() throws Exception {
		...
		assertEquals(bottomState, neq.op(in, a, IntConstant.v(1)));
		assertEquals(bottomState, neq.op(in, IntConstant.v(1),a));
		assertEquals(bottomState, neq.op(in, IntConstant.v(5),IntConstant.v(5)));
		assertEquals(bottomState, neq.op(in, a, a));
